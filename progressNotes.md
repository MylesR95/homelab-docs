...
Using VirtualBox, I deployed a Windows Server 2022 VM, configuring it with 4GB RAM, 64 GB storage and dedicated 2 CPU processors for the purpose 
of acting as a Domain Controller. 

Prior to running, I had also changed the Adapter 1 Network Settings from ATTATCHED TO > **NAT**  to ATTATCHED TO > **INTERNAL NETWORK**.
